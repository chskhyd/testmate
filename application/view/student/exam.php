        ...
        <div class="col-md-8">
            ...
            <div class="block">
                ...
                <div class="block-title text-center">
                    ...
                    <h2 class="h2"> Showing <strong class="text-primary"> <?php echo $value->quesnum;?></strong> of <strong class="text-primary"><?php echo $val->num;?></strong></h2>
				   ...
				   <div class="form-group">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-md-9 col-md-offset-2">
                           ...
                           <button type="submit" id="submit" name="submit" value="<?php echo $value->quesnum;?>" class="btn btn-sm btn-warning"><i class="fa fa-angle-right"></i> Submit </button>
...
$(".quit").bind("click", quitTest);
 ...
 <script>    
    if(typeof window.history.pushState == 'function') {
        window.history.pushState({}, "Hide", '<?php echo'./exam';?>');
    }
</script>
